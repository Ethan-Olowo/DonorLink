...
class _PageState extends State<ViewInteractions> {
  ...
  void initState() {
    ...
    if (widget.user == null && widget.type != null) {
      _elementsFuture = widget.admin.getInteractions(widget.type!);
    }
    if (widget.user == null && widget.type == null) {
      _elementsFuture = widget.admin.getAllInteractions();
    }
  }
              ...
              child: FutureBuilder<List<Interaction>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return Center(
                        child: Text('No ${widget.type!.capitalize()}s found.'));
                  }
