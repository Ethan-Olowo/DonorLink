...
class ViewInteraction extends StatefulWidget {
  ...
  final String type;
  const ViewInteraction({super.key, required this.user, required this.element, required this.type});
@override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(widget.type.capitalize(), style: Theme.of(context).textTheme.headlineSmall,),
              const SizedBox(height: 20),
          ...
          if(app!.approvalStatus==false) ElevatedButton(
              onPressed: () async {
                ...
                await widget.element.updateInteraction()? setState(() {
                  (widget.element as Appointment).approvalStatus = true;
