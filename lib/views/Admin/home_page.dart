      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text('Unapproved Reviewers', style: Theme.of(context).textTheme.headlineSmall),
            ...
            FutureBuilder<List<User>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return const Center(child: Text('No Unapproved Reviewers.'));
                }

                List<User> reviewers = snapshot.data!;
                
                reviewers = reviewers.where((rev) =>
                    rev.name!.toLowerCase().contains(_searchText.toLowerCase())).toList();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ViewUsers(user: widget.user, type: 'reviewer',),
                  ),
                );
              },
            ...
            Chart('Users'),
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ViewUsers(user: widget.user, type: 'organisation' ,),
                  ),
                );
              },
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ViewUsers(user: widget.user, type: 'donor' ,),
                  ),
                );
              },
            ...
            Text('Interactions', style: Theme.of(context).textTheme.headlineSmall,),
            const SizedBox(height: 20,),
            Chart('Interactions'),
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ViewInteractions(user: widget.user, type: 'donation' ,admin: widget.user),
                  ),
                );
              },
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ViewInteractions(user: widget.user, type: 'appointment', admin: widget.user ,),
                  ),
                );
              },
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ViewInteractions(user: widget.user, type: 'rating' ,admin: widget.user),
                  ),
                );
              },
            ...
            Text('Others', style: Theme.of(context).textTheme.headlineSmall,),
            const SizedBox(height: 20,),
            Chart('Others'),
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ViewFinancials(user: widget.user, org: null,),
                  ),
                );
              },
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ViewReviews(user: null, admin: widget.user,),
                  ),
                );
              },
            ...
            FutureBuilder<String>(
              ...
              builder: (context, snapshot) {
                ...
                return ListTile(
                  title: Text('System Stats Summary', style: Theme.of(context).textTheme.headlineSmall,),
